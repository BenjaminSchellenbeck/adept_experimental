...
int main (int argc, char **argv)
{
  ...
  actionlib::SimpleActionClient<PositionGripperCommandAction> GraspActionClient("gripper_action_server", true);
  ...
  PositionGripperCommandGoal grasp_goal;
  grasp_goal.position = 0.008;
